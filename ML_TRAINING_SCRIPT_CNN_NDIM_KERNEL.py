...
sm.overwriteModelMap(model, "model_multi_kernel.txt")
...
sm.appendToTxt("model_multi_kernel.txt", report)
plot = sm.plotTrainingAccuracy(history, "Training Accuracy - CNN MultiDimentional Kernel with residual approach")
plot.show()

# 18. Salva il modello con il nuovo formato keras
model.save("unclepaskm_cnn_multi.keras")